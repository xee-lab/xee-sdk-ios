 ...
 */
-(void)tripWithId:(NSString*)tripId completionHandler:(void (^)(XeeTrip *trip, NSArray<XeeError *> *errors))completionHandler;

/*!
 Get the locations history from a specific trip
 @param tripId The id of the trip you are looking for the locations
 */
-(void)locationsWithTripId:(NSString*)tripId completionHandler:(void (^)(NSArray<XeeLocation*> *locations, NSArray<XeeError *> *errors))completionHandler;

/*!
 Get the locations history from a specific trip as a Geojson LineString
 @param tripId The id of the trip you are looking for the locations
 */
-(void)locationsGeoJSONWithTripId:(NSString*)tripId completionHandler:(void (^)(NSArray *locations, NSArray<XeeError *> *errors))completionHandler;
