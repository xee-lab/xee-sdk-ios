...
-(void)setStyle:(XeeLoginButtonStyle)style {
    ...
    } else if (style == XeeLoginButtonStyleDark) {
...
-(void)setSize:(XeeLoginButtonSize)size {
    if(size == XeeLoginButtonSizeNormal) {
        label.hidden = false;
        CGRect frame = self.frame;
        frame.size.width = 180.0;
        self.frame = frame;
    } else if(size == XeeLoginButtonSizeIcon) {
        label.hidden = true;
        CGRect frame = self.frame;
